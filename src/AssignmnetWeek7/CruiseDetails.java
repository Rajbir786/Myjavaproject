...
public class CruiseDetails {
	...
	double priceForChildrenLessThanFiveYears = 0;
	...
	public double cruisePricingForChildren(int numberOfChildrenMoreThanFiveYears)//method for caluclating  price of cruise for children above 5
	{
	...
	double totalPricewithoutMeal()//method to calculate totalprice of cruise without meal
	{
